...
const Navbar = () => {
  ...
  useEffect(()=>{
    ...
    const navItems=(
        ...
        <li className=' dark:bg-slate-800 dark:text-white'>
        <a href='/'>Home</a>
        </li>
        <li className=' dark:bg-slate-800 dark:text-white'>
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer" href='/'><img src={Logo2} alt="" className='w-22 h-10 md:h-16 hover:scale-105 '/></a>
  </div>
  ...
  <label className=" px-3 py-1 border rounded-md p-2 flex items-center gap-2">
...

{
  authUser?<Logout/>:
  <div >
    <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer dark:bg-blue-600"
