...
const Signup = () => {
    ...
    const onSubmit = async (data) => {
        ...
        await axios.post('https://book-store-app-plum.vercel.app/user/signup',userInfo)
        .then((res)=>{
           ...
           if(err.response){
            toast.error("Error:User alraedy exists");
           }
        })
    };
    return (
                ...
                <div  className='w-[600px]'>
                    <div className="modal-box dark:bg-slate-800 dark:text-white">
                        ...
                        <div className='mt-4 space-y-2'>
                            <span>Password</span>
                            <br />
                            <input type="text" placeholder='Enter your password' className='w-80 px-3 py-1 border rounded-md outline-none  dark:bg-slate-800 dark:text-white' 
